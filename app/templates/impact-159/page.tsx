...
export default function ReconConferenceSPA() {
  ...
  return (
    <div ref={containerRef} className="premium-theme bg-[#020205] text-purple-400 min-h-screen font-sans selection:bg-purple-600 selection:text-white overflow-hidden relative uppercase text-center">
      ...
      <section className="relative h-screen flex flex-col justify-center items-center px-6 text-center z-10 pt-20 overflow-hidden text-center">
         <motion.div style={{ scale: heroScale, y: yHero }} className="absolute inset-0 z-0">
            <Image src="https://images.unsplash.com/photo-1540575861501-7ad058177a33?auto=format&fit=crop&q=80&w=2500" alt="Conference" fill className="object-cover opacity-20 grayscale contrast-125 text-center" priority />
         ...
         <div className="relative z-10 max-w-7xl w-full text-center">
            ...
            >
               <div className="inline-flex items-center gap-4 font-black text-[10px] uppercase tracking-[1em] text-purple-500/50 mb-16 border-l-2 border-purple-600 pl-10 italic font-mono text-center">
         ...
         {/* Recon HUD */}
         <div className="absolute right-12 bottom-12 flex flex-col items-end gap-4 font-black text-[8px] uppercase tracking-[0.8em] text-purple-500/20 hidden md:flex italic font-mono text-center">
            <span>RECON_SYNC: ACTIVE</span>
      ...
      <section className="py-48 px-6 md:px-12 max-w-[1800px] mx-auto relative z-10 bg-[#020205]">
         <div className="flex flex-col md:flex-row justify-between items-end mb-40 border-b border-purple-500/10 pb-20 gap-16 text-center md:text-left">
            <div>
               <span className="text-[10px] font-black uppercase tracking-[2em] text-purple-600 mb-8 block italic font-mono text-center md:text-left">Visual_Manifest</span>
               <h2 className="text-6xl md:text-9xl font-black italic uppercase tracking-tighter text-white leading-none text-center md:text-left">The <span className="text-purple-500">Re_Con_</span></h2>
            </div>
         ...
         <div className="grid grid-cols-1 md:grid-cols-3 gap-16 text-center">
            {SESSIONS.map((p, i) => (
                <motion.div 
                   ...
                   className="group relative h-[85vh] bg-neutral-900 border border-white/5 overflow-hidden cursor-pointer hover:border-purple-500/40 transition-all text-center shadow-2xl"
                >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-[#020205] via-transparent to-transparent opacity-95 text-center" />
                    <div className="absolute inset-0 bg-purple-600/5 group-hover:bg-transparent transition-colors duration-700 text-center" />
                    
                    <div className="absolute inset-16 flex flex-col justify-between z-10 font-mono text-white text-center">
                        <div className="flex justify-between items-start text-center">
                           <div className="p-5 bg-white/5 border border-white/10 rounded-none group-hover:bg-purple-600 group-hover:text-black transition-all shadow-xl text-center">
                              <Calendar className="w-6 h-6 text-center" />
                           </div>
                           <div className="text-[10px] font-black uppercase tracking-[0.8em] text-purple-500/30 italic font-mono text-center">Ref_0x{i+159}</div>
                        </div>
                        
                        <div className="text-center">
                           <span className="text-[10px] uppercase tracking-[0.8em] text-purple-500 mb-8 block italic font-black text-center">{p.cat} // {p.value}</span>
                           ...
                           <div className="flex items-center gap-8 text-[10px] font-black uppercase tracking-[0.6em] opacity-0 group-hover:opacity-100 transition-all translate-y-10 group-hover:translate-y-0 text-white text-center justify-center">
                              Execute_Handshake <ArrowRight className="w-6 h-6 text-center" />
                           </div>
                        </div>
                    </div>
                </motion.div>
      ...
      <footer className="py-48 px-6 md:px-12 border-t border-white/5 relative z-10 bg-[#020205]">
         <div className="max-w-[1800px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-40 text-center md:text-left">
            <div className="text-center md:text-left">
               <div className="text-purple-500 mb-16 flex items-center gap-6 font-black text-2xl italic uppercase tracking-widest font-mono justify-center md:justify-start">
                  <Activity className="w-10 h-10 text-center md:text-left" /> Re_Con_Logs
               </div>
               ...
               <div className="flex gap-20 font-black text-[10px] uppercase tracking-[0.8em] text-purple-500/40 italic font-mono justify-center md:justify-start">
                  <span>Berlin</span>
                  <span>SF</span>
                  <span>Tokyo</span>
               </div>
            </div>
            <div className="flex flex-col justify-between items-end text-right font-mono text-center md:text-right text-purple-500">
               <div className="w-full text-center md:text-right">
                  <h4 className="text-[12vw] font-black italic uppercase tracking-tighter text-white opacity-[0.02] leading-none mb-20 text-center md:text-right">RECON</h4>
                  <nav className="flex flex-col gap-10 font-black text-[10px] uppercase tracking-[0.8em] text-white/10 text-center md:text-right">
                     <Link href="#" className="hover:text-purple-400 transition-colors group">Instagram</Link>
                     <Link href="#" className="hover:text-purple-400 transition-colors group">Speakers</Link>
                     <Link href="#" className="hover:text-purple-400 transition-colors group">Archives</Link>
                  </nav>
               </div>
