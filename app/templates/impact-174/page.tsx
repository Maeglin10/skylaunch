...
import { Dumbbell, Activity, ShieldPlus, Flame, Menu, Search, ArrowRight, Layers, Zap, Compass } from "lucide-react";
import "../premium.css";
...
export default function ApexFitnessSPA() {
  ...
  return (
    <div ref={containerRef} className="premium-theme bg-[#050505] text-[#FAFAFA] min-h-screen font-sans selection:bg-[#E11D48] selection:text-white overflow-hidden relative uppercase">
      
      {/* PERFORMANCE GRID & NOISE */}
      <div className="fixed inset-0 z-0 pointer-events-none">
        <div className="absolute inset-0 bg-[linear-gradient(rgba(225,29,72,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(225,29,72,0.05)_1px,transparent_1px)] bg-[size:10rem_10rem] [mask-image:radial-gradient(ellipse_60%_60%_at_50%_50%,#000_70%,transparent_100%)]" />
        <motion.div 
           style={{ x: springX, y: springY }}
           className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[70vw] h-[70vw] bg-[#E11D48] opacity-[0.05] blur-[150px] rounded-full mix-blend-screen" 
        />
      ...
      <section className="relative h-screen flex flex-col justify-center items-center px-6 text-center z-10 pt-20 overflow-hidden text-center text-center">
         ...
         <div className="relative z-10 max-w-7xl w-full text-center">
            ...
            >
               <div className="inline-flex items-center gap-4 font-black text-[10px] uppercase tracking-[1em] text-[#E11D48] mb-16 border-l-2 border-[#E11D48] pl-10 italic font-mono text-center">
         ...
         {/* Biometric HUD */}
         <div className="absolute right-12 bottom-12 flex flex-col items-end gap-4 font-black text-[8px] uppercase tracking-[1em] text-[#E11D48]/30 hidden md:flex italic font-mono text-center">
            <span>HEART_RATE: 165 BPM</span>
         ...
         <div className="absolute left-12 bottom-12 hidden md:block">
            <div className="flex flex-col gap-2 text-[8px] font-black uppercase tracking-[0.4em] text-white/10 italic font-mono text-center">
               <span>VO2_MAX: 64.2</span>
               <span>CAL_BURN: 840/H</span>
               <span>STATUS: PEAK</span>
            </div>
         </div>
      </section>
      ...
      <section className="py-48 px-6 md:px-12 max-w-[1800px] mx-auto relative z-10 bg-[#050505]">
         <div className="flex flex-col md:flex-row justify-between items-end mb-40 border-b border-white/10 pb-20 gap-16">
            <div>
               ...
               <h2 className="text-6xl md:text-[10vw] font-black italic uppercase tracking-tighter text-white leading-none text-center md:text-left">The <span className="text-[#E11D48]/20">Pillars_</span></h2>
            </div>
         ...
         <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
            {PILLARS.map((p, i) => (
                <motion.div 
                   ...
                   className="group relative h-[85vh] bg-white/5 border border-white/5 overflow-hidden cursor-pointer hover:border-[#E11D48]/30 transition-all shadow-2xl"
                >
      ...
      <footer className="py-48 px-6 md:px-12 border-t border-white/5 relative z-10 bg-[#050505]">
         <div className="max-w-[1800px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-40 font-sans text-center md:text-left">
            <div className="max-w-2xl text-center md:text-left">
               <div className="text-[#E11D48] mb-16 flex items-center gap-6 font-black text-2xl italic uppercase tracking-widest font-mono justify-center md:justify-start">
               ...
               <div className="flex gap-20 font-black text-[10px] uppercase tracking-[0.8em] text-[#E11D48]/40 italic font-mono justify-center md:justify-start">
                  <span>Berlin</span>
                  <span>London</span>
                  <span>NYC</span>
               </div>
            ...
            <div className="flex flex-col justify-between items-end text-right font-mono text-center md:text-right">
               <div className="w-full text-center md:text-right">
                  <h4 className="text-[12vw] font-black italic uppercase tracking-tighter text-white opacity-[0.02] leading-none mb-20 text-center md:text-right">APEX</h4>
