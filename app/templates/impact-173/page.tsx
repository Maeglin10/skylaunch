...
import { Hammer, HardHat, Ruler, Building2, Menu, Search, ArrowRight, Layers, Activity, Zap, Compass } from "lucide-react";
import "../premium.css";
...
export default function IroncladConstructionSPA() {
  ...
  return (
    <div ref={containerRef} className="premium-theme bg-[#0A0A0A] text-white min-h-screen font-sans selection:bg-[#FFB800] selection:text-black overflow-hidden relative uppercase">
      
      {/* INDUSTRIAL GRID & NOISE */}
      <div className="fixed inset-0 z-0 pointer-events-none">
        <div className="absolute inset-0 bg-[linear-gradient(rgba(255,184,0,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(255,184,0,0.05)_1px,transparent_1px)] bg-[size:10rem_10rem] [mask-image:radial-gradient(ellipse_60%_60%_at_50%_50%,#000_70%,transparent_100%)]" />
        <motion.div 
           style={{ x: springX, y: springY }}
           className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[70vw] h-[70vw] bg-[#FFB800] opacity-[0.03] blur-[150px] rounded-full mix-blend-screen" 
        />
      ...
      <header className="fixed top-0 left-0 w-full px-6 md:px-12 py-10 flex justify-between items-center z-50 bg-[#0A0A0A]/50 backdrop-blur-3xl border-b border-white/5">
        <Link href="/" className="font-black text-2xl tracking-[0.3em] text-white flex items-center gap-4 italic uppercase text-center md:text-left">
           IRONCLAD<span className="text-[#FFB800]">_SYSTEMS</span>
        </Link>
        ...
        <div className="flex items-center gap-10">
           <button className="bg-[#FFB800] text-black px-12 py-4 font-black text-[10px] uppercase tracking-[0.4em] hover:bg-white transition-all shadow-[0_0_40px_rgba(255,184,0,0.2)]">
              Get_A_Quote
           </button>
      ...
      <section className="relative h-screen flex flex-col justify-center items-center px-6 text-center z-10 pt-20 overflow-hidden text-center text-center">
         ...
         <div className="relative z-10 max-w-7xl w-full text-center">
            ...
            >
               <div className="inline-flex items-center gap-4 font-black text-[10px] uppercase tracking-[1em] text-[#FFB800] mb-16 border-l-2 border-[#FFB800] pl-10 italic font-mono text-center">
         ...
         {/* Blueprint HUD */}
         <div className="absolute right-12 bottom-12 flex flex-col items-end gap-4 font-black text-[8px] uppercase tracking-[1em] text-[#FFB800]/20 hidden md:flex italic font-mono text-center">
            <span>DRAWING_SYNC: ACTIVE</span>
         ...
         <div className="absolute left-12 bottom-12 hidden md:block">
            <div className="flex flex-col gap-2 text-[8px] font-black uppercase tracking-[0.4em] text-white/10 italic font-mono text-center">
               <span>LOAD_CAP: 400T</span>
               <span>TENSION: OPTIMAL</span>
               <span>GRID_REF: IC_99</span>
            </div>
         </div>
      </section>
      ...
      <section className="py-48 px-6 md:px-12 max-w-[1800px] mx-auto relative z-10 bg-[#0A0A0A]">
         <div className="flex flex-col md:flex-row justify-between items-end mb-40 border-b border-white/10 pb-20 gap-16">
            <div>
               ...
               <h2 className="text-6xl md:text-[10vw] font-black italic uppercase tracking-tighter text-white leading-none text-center md:text-left">The <span className="text-[#FFB800]/20">Services_</span></h2>
            </div>
         ...
         <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
            {SERVICES.map((p, i) => (
                <motion.div 
                   ...
                   className="group relative h-[85vh] bg-white/5 border border-white/5 overflow-hidden cursor-pointer hover:border-[#FFB800]/30 transition-all shadow-2xl"
                >
      ...
      <footer className="py-48 px-6 md:px-12 border-t border-white/5 relative z-10 bg-[#0A0A0A]">
         <div className="max-w-[1800px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-40 font-sans text-center md:text-left">
            <div className="max-w-2xl text-center md:text-left">
               <div className="text-[#FFB800] mb-16 flex items-center gap-6 font-black text-2xl italic uppercase tracking-widest font-mono justify-center md:justify-start">
               ...
               <div className="flex gap-20 font-black text-[10px] uppercase tracking-[0.8em] text-[#FFB800]/40 italic font-mono justify-center md:justify-start">
                  <span>Berlin</span>
                  <span>London</span>
                  <span>NYC</span>
               </div>
            ...
            <div className="flex flex-col justify-between items-end text-right font-mono text-center md:text-right">
               <div className="w-full text-center md:text-right">
                  <h4 className="text-[12vw] font-black italic uppercase tracking-tighter text-white opacity-[0.02] leading-none mb-20 text-center md:text-right">IRONCLAD</h4>
