...
export default function OnyxStudioSPA() {
  ...
  return (
    <div ref={containerRef} className="premium-theme bg-black text-white min-h-screen font-sans selection:bg-white selection:text-black overflow-hidden relative">
      ...
      <section className="relative h-screen flex flex-col justify-center items-center px-6 text-center z-10 pt-20 overflow-hidden">
         <motion.div style={{ scale: heroScale, y: yHero }} className="absolute inset-0 z-0">
            <Image src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&q=80&w=2500" alt="Studio" fill className="object-cover opacity-20 grayscale contrast-125" priority />
         ...
         <div className="relative z-10 max-w-7xl w-full">
            ...
            >
               <div className="inline-flex items-center gap-4 font-black text-[10px] uppercase tracking-[1em] text-white/20 mb-16 border-l-2 border-white pl-10 italic font-mono">
         ...
         {/* Decorative Side HUD */}
         <div className="absolute right-12 bottom-12 flex flex-col items-end gap-4 font-black text-[8px] uppercase tracking-[0.8em] text-white/20 hidden md:flex italic font-mono">
      ...
      <section className="py-48 px-6 md:px-12 max-w-[1800px] mx-auto relative z-10 bg-black">
         <div className="flex flex-col md:flex-row justify-between items-end mb-40 border-b border-white/10 pb-20 gap-16">
            <div>
               <span className="text-[10px] font-black uppercase tracking-[2em] text-white/40 mb-8 block italic font-mono">Visual_Manifest</span>
               <h2 className="text-6xl md:text-9xl font-black italic uppercase tracking-tighter text-white leading-none">The <span className="text-white/10">Onyx_</span></h2>
            </div>
         ...
         <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
            {PROJECTS.map((p, i) => (
                <motion.div 
                   ...
                   className="group relative h-[85vh] bg-neutral-900 border border-white/5 overflow-hidden cursor-pointer hover:border-white/40 transition-all shadow-2xl"
                >
                    ...
                    <div className="absolute inset-16 flex flex-col justify-between z-10 font-mono">
                        <div className="flex justify-between items-start">
                           ...
                           <div className="text-[10px] font-black uppercase tracking-[0.8em] text-white/20 italic">Ref_0x{i+164}</div>
                        </div>
                        
                        <div>
                           <span className="text-[10px] uppercase tracking-[0.8em] text-stone-400 mb-8 block italic font-black">{p.cat} // {p.value}</span>
      ...
      <footer className="py-48 px-6 md:px-12 border-t border-white/5 relative z-10 bg-black">
         <div className="max-w-[1800px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-40">
            <div className="max-w-2xl">
               <div className="text-white mb-16 flex items-center gap-6 font-black text-2xl italic uppercase tracking-widest font-mono">
                  <Activity className="w-10 h-10" /> Onyx_Logs_v4
               </div>
            ...
            <div className="flex flex-col justify-between items-end text-right font-mono">
               <div className="w-full">
                  <h4 className="text-[12vw] font-black italic uppercase tracking-tighter text-white opacity-[0.02] leading-none mb-20">ONYX</h4>
                  <nav className="flex flex-col gap-10 font-black text-[10px] uppercase tracking-[0.8em] text-white/10">
                     ...
                     <Link href="#" className="hover:text-white transition-colors group">
                        Behance<span className="text-white/0 group-hover:text-white transition-all">_</span>
                     </Link>
                     <Link href="#" className="hover:text-white transition-colors group">
                        Contact<span className="text-white/0 group-hover:text-white transition-all">_</span>
                     </Link>
                  </nav>
               </div>
