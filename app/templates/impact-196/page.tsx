  ...
  return (
    <div ref={containerRef} className="premium-theme bg-[#000] text-[#FFF] min-h-screen font-sans selection:bg-[#FFF] selection:text-[#000] overflow-hidden relative uppercase">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none text-center">
        <div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.03)_1px,transparent_1px)] bg-[size:10rem_10rem] [mask-image:radial-gradient(ellipse_60%_60%_at_50%_50%,#000_70%,transparent_100%)]" />
        <motion.div 
           style={{ x: springX, y: springY }}
           className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[70vw] h-[70vw] bg-[#FFF] opacity-[0.05] blur-[150px] rounded-full mix-blend-screen" 
        />
        <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-[0.1] mix-blend-screen" />
      </div>

      {/* HEADER */}
      <header className="fixed top-0 left-0 w-full px-6 md:px-12 py-10 flex justify-between items-center z-50 bg-black/50 backdrop-blur-3xl border-b border-white/5 text-center">
        ...
        <div className="flex items-center gap-10">
           <button className="bg-white text-black px-12 py-4 font-sans font-black text-[10px] uppercase tracking-[0.4em] hover:bg-white/80 transition-all shadow-[0_0_40px_rgba(255,255,255,0.2)]">
              View_System
           </button>
      ...
      <section className="relative h-screen flex flex-col justify-center items-center px-6 text-center z-10 pt-20 overflow-hidden text-center text-center">
         ...
         <div className="relative z-10 max-w-7xl w-full text-center">
            ...
            >
               <div className="inline-flex items-center gap-4 font-sans font-black text-[10px] uppercase tracking-[1em] text-white mb-16 border-l-2 border-white pl-10 italic font-mono text-center">
               ...
               <div className="flex flex-col md:flex-row gap-16 justify-center items-center font-sans font-mono text-white text-center text-center text-center">
         ...
         {/* Decorative Side HUD */}
         <div className="absolute right-12 bottom-12 flex flex-col items-end gap-4 font-sans font-black text-[8px] uppercase tracking-[1em] text-white/20 hidden md:flex italic font-mono text-center">
      ...
      <section className="py-48 px-6 md:px-12 max-w-[1800px] mx-auto relative z-10 bg-[#000]">
         <div className="flex flex-col md:flex-row justify-between items-end mb-40 border-b border-white/10 pb-20 gap-16 font-sans">
            <div>
               <span className="text-[10px] font-black uppercase tracking-[2em] text-white mb-8 block italic font-mono">System_Manifest</span>
               <h2 className="text-6xl md:text-[10vw] font-black italic uppercase tracking-tighter text-white leading-none">The <span className="text-white/20">Archive_</span></h2>
            </div>
         ...
         <div className="grid grid-cols-1 md:grid-cols-3 gap-16 font-sans">
            {SHOWCASE.map((p, i) => (
                <motion.div 
                   ...
                   className="group relative h-[85vh] bg-stone-900 border border-white/5 overflow-hidden cursor-pointer hover:border-white/30 transition-all shadow-2xl"
                >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-[#000] via-transparent to-transparent opacity-95" />
                    ...
                    <div className="absolute inset-16 flex flex-col justify-between z-10 font-mono text-white">
                        <div className="flex justify-between items-start">
                           <div className="p-5 bg-white/5 border border-white/10 rounded-none group-hover:bg-white group-hover:text-black transition-all shadow-xl">
                              {p.icon}
                           </div>
                           <div className="text-[10px] font-black uppercase tracking-[0.8em] text-white italic font-mono">Ref_0x{i+196}</div>
                        </div>
                        
                        <div>
                           <span className="text-[10px] uppercase tracking-[0.8em] text-white mb-8 block italic font-black">{p.cat} // Verified</span>
                           ...
                           <div className="flex items-center gap-8 text-[10px] font-black uppercase tracking-[0.6em] opacity-0 group-hover:opacity-100 transition-all translate-y-10 group-hover:translate-y-0 text-white">
                              View_System <ArrowRight className="w-6 h-6" />
                           </div>
                        </div>
                    </div>
                </motion.div>
         ...
         <div className="max-w-[1800px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-40 font-sans text-center md:text-left">
            <div className="max-w-2xl">
               <div className="text-white mb-16 flex items-center gap-6 font-black text-2xl italic uppercase tracking-widest font-mono justify-center md:justify-start">
                  <Activity className="w-10 h-10" /> Final_Logs
               </div>
            ...
            <div className="flex flex-col justify-between items-end text-right font-mono text-white text-center">
               <div className="w-full">
                  <h4 className="text-[12vw] font-black italic uppercase tracking-tighter opacity-[0.02] leading-none mb-20 text-white">GRAND</h4>
